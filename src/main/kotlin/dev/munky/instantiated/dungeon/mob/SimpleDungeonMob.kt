...
class SimpleDungeonMob(
    ...
    override fun toString(): String {
        return "simple.$identifier#${livingEntity.getOrNull()?.javaClass?.simpleName ?: "Unconfigured"}"
    }

    override fun clone(): SimpleDungeonMob {
        return SimpleDungeonMob(identifier,spawnLocation,isMarked,custom,livingEntity)
    }
}